...
function About() {
  return (
    <div className="main">
      <NavBar />
      <div className="about">
        <div className="header-image" alt=""></div>
        <div className="column">
          ...
          <p className="info-text">
            ...
            Full-stack by day, plant/animal lover, musician and artist by night.
            She enjoys hiking, yoga, knitting and tormenting her husband with
            healthy food and scrabble. www.heatherluttrell.com
          </p>
          <div className="c-image">
